module.exports = function(module) {
  var model = {
    ...
    save: function(new_bank) {
      var Bank = module.db.Object.extend("Bank");
      var bank = new Bank();
    ...
    getBank: function(bankID) {
      var deferred = m.deferred();
      var Bank = module.db.Object.extend("Bank");
      var query = new module.db.Query(Bank);
      query.get(bankID, {
        ...
        error: function(object, error) {
          ...
          deferred.reject("Error occured retrieving Bank: " +
            object)
        }
      });
      return deferred.promise;
    ...
    getAll: function() {
      ...
      query.find({
        ...
        error: function(object, error) {
          console.log("Error occured retrieving Bank library: " +
            object);
          deferred.reject("Error occured retrieving Bank library: " +
            object);
        }
      });
      return deferred.promise;
